      ...
      <div className="bg-slate-50 min-h-screen">
        ...
        <section className="relative overflow-hidden pt-20 pb-32 md:pt-32 md:pb-48">
          ...
          <div className="relative mx-auto max-w-7xl px-6 text-center text-white">
            <div className="inline-flex items-center gap-2 rounded-full bg-red-500/10 px-4 py-2 text-sm font-bold text-red-400 ring-1 ring-inset ring-red-500/20 mb-8">
              <ShieldAlert size={16} />
              ImpactGuard™ Technology
            </div>
            <h1 className="text-5xl font-black tracking-tight md:text-8xl mb-8">
              Safety that <br />
              <span className="text-blue-500">doesn't blink.</span>
            </h1>
